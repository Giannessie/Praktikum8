...
<?php echo form_open("matakuliah/save")?>
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="nama" name="nama" placeholder="Masukkan Matakuliah" type="text" class="form-control">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="kode" name="kode" placeholder="Masukkan Kode Matakuliah" type="text" class="form-control">
    </div>
  </div> 
  <div class="form-group row">
